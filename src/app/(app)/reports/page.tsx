...
const reports = [
  {
    title: 'DSE Compliance Report',
    description: 'All users, DSE status, outstanding actions',
    slug: 'dse',
    filename: 'dse-compliance-report.xlsx',
    icon: (
  ...
  },
  {
    ...
    description: 'All CAs with status, priority, source, overdue count',
    slug: 'corrective-actions',
    filename: 'corrective-actions-report.xlsx',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: 'All incidents including RIDDOR status',
    slug: 'incidents',
    filename: 'incident-summary-report.xlsx',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Training records with expiry status',
    slug: 'training',
    filename: 'training-expiry-report.xlsx',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Equipment with service dates and overdue status',
    slug: 'equipment',
    filename: 'equipment-service-report.xlsx',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: 'All items across all modules past their due date',
    slug: 'overdue',
    filename: 'overdue-items-report.xlsx',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Generate and export data reports across all Health &amp; Safety modules.
        </p>
      </div>
