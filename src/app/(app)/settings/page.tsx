...
export default async function SettingsPage() {
  ...
  const cards = [
    ...
    },
    {
      ...
      description: 'Register emergency light fittings per site for use in test forms',
      href: '/settings/emergency-lights',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Register fire alarm panels used when logging alarm tests',
      href: '/settings/fire-alarm-systems',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    {
      title: 'Skills Matrix',
      description: 'Define the skill columns tracked in the staff competency matrix',
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">Manage system configuration, users, and reference data.</p>
      </div>
